...
rail_export_dir = os.path.join(files_dir, 'xlsx_rail_export')                   # Путь к папке с файлами Ж/Д перевозок
...
archive_rail_export_dir = os.path.join(archive_dir, 'xlsx_rail_export')         # Путь к папке с архивными файлами Ж/Д перевозок
